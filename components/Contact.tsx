    ...
    <section id="contact" className="min-h-screen w-full bg-gray-50 flex items-center justify-center px-8 py-20">
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-14 items-center" data-aos="fade-up">
        <div className="space-y-8">
          <h3 className="text-5xl font-serif font-bold  text-red-600 tracking-wider">Contact</h3>
          ...
          <div className="space-y-6 text-2xl text-gray-800 font-light">
            <p>
              ...
              <a href="mailto:manuraaluthge@gmail.com" className="font-extralight underline hover:text-red-500 transition">
            ...
            <p>
              ...
              <a href="https://wa.me/94773433747" className="font-extralight underline hover:text-red-500 transition" >
                077 343 3747
              </a>
            </p>
            ...
            <p>
              ...
              <a href="tel:+94113437672" className="font-extralight underline hover:text-red-500 transition">
                +94 11 343 7672
              </a>
            </p>
            ...
            <p>
              ...
              className="font-extralight text-black underline hover:text-red-500 transition" >
