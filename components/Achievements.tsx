      ...
      <div className="max-w-7xl mx-auto" data-aos="fade-left">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="relative group rounded-2xl overflow-hidden shadow-xl">
            ...
            />
            <div className="absolute inset-0 bg-black/50 flex flex-col justify-center items-center text-center p-6">
              <h4 className="text-white text-3xl font-bold mb-3">Global Innovation Award</h4>
              <p className="text-gray-200 text-base">Recognized for innovative leadership in sustainable infrastructure projects</p>
            </div>
          </div>
        </div>
      </div>
